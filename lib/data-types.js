...
class DATE extends ABSTRACT {
  ...
  _stringify(date, options) {
    ...
    // this hard format is a hassle with mssql and no offset, but ultimately I did this which is super flexible
    //already have the field options info, let the model/field def override if desired for insert
    if(options.field.dateFormat != undefined){
